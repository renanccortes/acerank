    ...
    return {
      ...
      progress: {
        points: {
          ...
          percentage: Math.min(100, (this.points / requirements.pointsNeeded) * 100)
        },
        games: {
          current: totalGames,
          needed: requirements.gamesNeeded,
          percentage: Math.min(100, (totalGames / requirements.gamesNeeded) * 100)
        },
        winRate: {
          current: winRate,
          needed: requirements.winRateNeeded,
          percentage: Math.min(100, (winRate / requirements.winRateNeeded) * 100)
        }
      },
